...
export const API_TOKEN_SCOPES = [
  ...
  { scope: 'read:alerts', description: 'Leer alertas activas e historial' },
  { scope: 'write:terraform', description: 'Ejecutar planes y applies Terraform' },
  { scope: 'read:inventory', description: 'Consultar inventario de recursos' },
  { scope: 'read:dashboard', description: 'Solo lectura del panel principal' },
  { scope: 'read:logs', description: 'Acceso a logs agregados (solo staging)' },
  { scope: 'read:*', description: 'Lectura global en todos los módulos' },

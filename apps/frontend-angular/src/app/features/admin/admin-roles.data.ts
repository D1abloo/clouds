...
export const ADMIN_ROLES: AdminRoleRow[] = [
  {
    ...
    description: 'Acceso total: usuarios, roles, infraestructura, nubes, seguridad y configuración.',
    usersCount: 1,
    permissionsCount: 13,
    status: 'running',
    builtin: true,
  ...
  },
  {
    ...
    name: 'Administrador',
    slug: 'administrador',
    description: 'Gestión operativa, integraciones cloud/repos y configuración sin rol superadmin.',
    usersCount: 2,
    permissionsCount: 13,
    status: 'running',
    builtin: true,
  ...
  },
  {
    ...
    name: 'Operador',
    slug: 'operador',
    description: 'Ejecución de infraestructura y conexión de repositorios.',
    usersCount: 3,
    permissionsCount: 4,
    status: 'running',
    builtin: true,
  ...
  },
  {
    ...
    name: 'Auditor',
    slug: 'auditor',
    description: 'Lectura de auditoría, seguridad e inventario sin cambios.',
    usersCount: 1,
    permissionsCount: 4,
    status: 'running',
    builtin: true,
  ...
  },
  {
    ...
    name: 'Solo lectura',
    slug: 'solo_lectura',
    description: 'Consulta de usuarios, infraestructura, seguridad y auditoría sin acciones.',
    usersCount: 2,
    permissionsCount: 4,
    status: 'running',
    builtin: true,
...
export const ADMIN_PERMISSIONS: AdminPermissionRow[] = [
  { id: 'p-1', resource: 'usuarios', action: 'leer', description: 'Ver usuarios', superAdmin: true, admin: true, operator: false, viewer: true },
  { id: 'p-2', resource: 'usuarios', action: 'crear', description: 'Crear usuarios', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-3', resource: 'usuarios', action: 'editar', description: 'Editar usuarios', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-4', resource: 'usuarios', action: 'eliminar', description: 'Eliminar usuarios', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-5', resource: 'roles', action: 'gestionar', description: 'Gestionar roles', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-6', resource: 'infraestructura', action: 'leer', description: 'Ver infraestructura', superAdmin: true, admin: true, operator: true, viewer: true },
  { id: 'p-7', resource: 'infraestructura', action: 'gestionar', description: 'Gestionar infraestructura', superAdmin: true, admin: true, operator: true, viewer: false },
  { id: 'p-8', resource: 'nubes', action: 'conectar', description: 'Conectar nubes', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-9', resource: 'repositorios', action: 'conectar', description: 'Conectar repositorios', superAdmin: true, admin: true, operator: true, viewer: false },
  { id: 'p-10', resource: 'seguridad', action: 'leer', description: 'Ver seguridad', superAdmin: true, admin: true, operator: true, viewer: true },
  { id: 'p-11', resource: 'seguridad', action: 'gestionar', description: 'Gestionar seguridad', superAdmin: true, admin: true, operator: false, viewer: false },
  { id: 'p-12', resource: 'auditoria', action: 'leer', description: 'Ver auditoría', superAdmin: true, admin: true, operator: false, viewer: true },
  { id: 'p-13', resource: 'configuracion', action: 'gestionar', description: 'Gestionar configuración', superAdmin: true, admin: true, operator: false, viewer: false },
]

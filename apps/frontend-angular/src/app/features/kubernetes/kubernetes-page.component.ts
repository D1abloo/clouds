...
import { mergeKubernetesPageData } from '../infrastructure/infrastructure.data'
...
export class KubernetesPageComponent implements OnInit {
  ...
  handleHeader = (label: string): void => {
    if (label === 'Conectar cluster') {
      this.connections.openKubernetes({ preferDialog: true }).subscribe()
      return
    }

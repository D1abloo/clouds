...
export const DOC_CATEGORIES: DocCategory[] = [
  ...
  { id: 'cloud', title: 'Nubes e infraestructura', icon: 'cloud_queue', description: 'AWS, GCP, instancias y VPS' },
  { id: 'automation', title: 'Automatización', icon: 'build_circle', description: 'CI/CD, Terraform, runbooks y programador' },
...
export const DOC_ARTICLES: DocArticle[] = [
  {
    ...
    blocks: [
      ...
      ul(
        'Conectar cuentas AWS, GCP y Azure y sincronizar inventario en vivo',
        ...
        'Revisar facturación y costes por instancia y proveedor',
        'Integrar Jenkins, Terraform, GitHub y GitLab',
      ...
      p('El panel se organiza en módulos del menú lateral: Resumen, Nubes, VPS, Infraestructura, Automatización, Repositorios, Observabilidad, Seguridad y Configuración. Cada módulo agrupa pestañas relacionadas para que encuentres rápido lo que necesitas.'),
    ],
  },
  {
    id: 'register',
  ...
  },
  {
    ...
    title: 'Jenkins y Terraform',
    description: 'Pipelines CI/CD e infraestructura como código.',
    icon: 'build',
    categoryId: 'automation',
    readMinutes: 5,
    tags: ['jenkins', 'terraform', 'cicd'],

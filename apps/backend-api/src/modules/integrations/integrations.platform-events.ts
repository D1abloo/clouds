...
export const PLATFORM_EVENT_SOURCES = [
  ...
  },
  {
    ...
    route: '/jenkins/overview',
    connectRoute: '/jenkins/overview',
  ...
  },
  {
    ...
    connectRoute: '/terraform/workspaces',
  ...
  },
  {
    ...
    module: 'GithubModule',
    route: '/repositories/github/overview',
    connectRoute: '/admin/configuracion/integraciones/github/conectar',
    events: [PLATFORM_EVENTS.DEPLOY_SUCCESS, PLATFORM_EVENTS.DEPLOY_FAILED, PLATFORM_EVENTS.WORKFLOW_RUN],
  },
  {
    id: 'vps',
  ...
  },
  {
    ...
    route: '/overview/command-center',
    connectRoute: '/overview/command-center',
